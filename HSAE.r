...
data<-read.table('d:/cosas nuevas a guardar en H/Lonicera/Lonicera2012/paperherko/HSA/HSAE2.csv',sep=';',head=T)
...
M02<-lm(seedsfloC~herkoRelaC, na.action=na.omit, data=data)
summary(M02)
